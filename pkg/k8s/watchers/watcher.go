...
type ipcacheManager interface {
	...
	UpsertLabelsWithoutInjection(prefix netip.Prefix, lbls labels.Labels, src source.Source, resource ipcacheTypes.ResourceID)
	RemoveLabelsWithoutInjection(prefix netip.Prefix, lbls labels.Labels, resource ipcacheTypes.ResourceID)
}
